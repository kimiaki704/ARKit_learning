...
final class BLEARKitDrawerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        mainViewController = DrawerNavigationController(rootViewController: UIStoryboard.instantiate(name: "BLEARKitViewController"), leftBarIcon: UIImage(named: "navbar_icon")!)
        menuViewController = UIStoryboard.instantiate(name: "BLEARKitMenuViewController")
